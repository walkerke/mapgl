...
This function subtracts the second geometry from the first. The result
...
- layer_id:
  ...
  The ID of the first layer or source (geometry to subtract from,
  mutually exclusive with data).

- layer_id_2:

  The ID of the second layer or source (geometry to subtract, mutually
  exclusive with data_2).

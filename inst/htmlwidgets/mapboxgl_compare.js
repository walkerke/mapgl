    ...
    return {
      renderValue: function(x) {
        ...
        function applyMapModifications(map, mapData) {
          ...
          if (mapData.fullscreen_control && mapData.fullscreen_control.enabled) {
          ...
          if (mapData.layers_control) {
            ...
            layersControl.className = mapData.layers_control.collapsible ? 'layers-control collapsible' : 'layers-control';
            layersControl.style.position = 'absolute';
            layersControl.style[mapData.layers_control.position || 'top-right'] = '10px';
            ...
            let layers = mapData.layers_control.layers || map.getStyle().layers.map(layer => layer.id);
